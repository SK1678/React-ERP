  ...
  handleToggleModal = (edit = false, store = null) => {
    if (edit && store) {
      ...
      this.setState({ 
        ...
        editMode: false,
        currentStore: {
          id: '', parentStore: '', name: '', logo: '', prefix: '', code: '', tin: '', bin: '', address: '', state: '', city: '',
                   ...
                   <div 
                    ...
                    >
                      {this.state.currentStore.logo ? (
                        <img src={this.state.currentStore.logo} alt="logo" style={{ maxWidth: '100%', maxHeight: '100%' }} />
                      ) : (
                ...
                <div className="col-md-6">
                  ...
                  <div className="row">
                    <div className="col-6">
                      <Form.Group>
                        <label>State</label>
                        <Form.Control type="text" name="state" value={this.state.currentStore.state} onChange={this.handleInputChange} />
                      </Form.Group>
                    </div>
                    <div className="col-6">
                      <Form.Group>
                        <label>City</label>
                        <Form.Control type="text" name="city" value={this.state.currentStore.city} onChange={this.handleInputChange} />
                      </Form.Group>
                    </div>
                  </div>
                  <div className="row">
